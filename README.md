...
```mermaid
---
title: Metodologia ESI (Entendimento - Solução - Implantação)
---

graph LR
    A[**ENTENDIMENTO**<br>• Negócios <br>• Requisitos<br>• Dados] -->

    B[**SOLUÇÃO**<br>• Extração<br>• Transformação <br>• Modelagem <br>• Cálculos<br>• Visualização]  -->

    C[**IMPLANTAÇÃO**<br>• Comportamento<br>• Automatização<br>• Entrega<br>• Acompanhamento]
```
...
graph LR
    ...
    subgraph Dimensões
        ...
        dPlanoConta["dPlanoConta"]
        dEstruturaDRE["dEstruturaDRE"]
    end

    subgraph Fatos
        fLancamentos["fLancamentos"]
        fOrcamento["fOrcamento"]
        fPrevisao["fPrevisao"]
    end

    subgraph Tabelas Auxiliares
        auxMeta["auxMeta"]
        Medidas["Medidas<br>• Medidas DAX <br>• Títulos Dinâmicos<br>"]
    end

    %% Relacionamentos principais
    dCalendario --> fLancamentos
    dCalendario --> fOrcamento
    dCalendario --> fPrevisao

    dPlanoConta --> fLancamentos
    dPlanoConta --> fOrcamento
    dPlanoConta --> fPrevisao

    dEstruturaDRE --> dPlanoConta

    %% Parametro de escolha entre Orcado e Previsto
    auxMeta -. parametro .- fOrcamento
    auxMeta -. parametro .- fPrevisao

    %% Medidas consumindo fatos
    Medidas -. referenciam .- fLancamentos
```
...
<details>
<summary><strong>🎯 Metas e Desempenho</strong></summary>
...
<details>
<summary><strong>⏳ Análises Temporais</strong></summary>
...
<details>
<summary><strong>⚙️ Eficiência Operacional</strong></summary>
...
<details>
<summary><strong>💸 Despesas e Custos</strong></summary>
...
<details>
<summary><strong>📘 Indicadores Contábeis</strong></summary>
